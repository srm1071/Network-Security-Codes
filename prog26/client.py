...
while True:
	...
	print ("#               MENU APP                     #")
	print ("# Options:                                   #")
	print ("# [1] sum and sum of the result #")
	print ("# [0] Exit                                   #")
	print ("#--------------------------------------------#")
	...
	if option == "1":
		...
		if returnedMessage:
			print('Numbers are: ',returnedMessage[2],' and ', returnedMessage[3])
			print('sum is: ', returnedMessage[0] ,' and multiplication of the digits are: ',returnedMessage[1])
